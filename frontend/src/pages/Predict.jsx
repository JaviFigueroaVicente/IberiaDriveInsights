                    ...
                    >
                        ...
                        <AnimatePresence mode="wait">
                            <motion.p 
                                ...
                                className="text-[11px] font-bold text-(--secondary) tracking-widest uppercase"
                            >
                ...
                >
                    ...
                    >
                        ...
                        <div className="space-y-8 relative z-10">
                            ...
                            <div className="bg-black/40 p-5 rounded-sm border border-white/5 backdrop-blur-xs group hover:border-(--secondary)/20 transition-colors duration-300">
                        ...
                        <div className="mt-12 space-y-4 relative z-10">
                            <motion.button 
                                ...
                                className={`btn-primary-engine w-full flex items-center justify-center gap-3 py-4 transition-all duration-300 border ${
                                    !formData.version 
